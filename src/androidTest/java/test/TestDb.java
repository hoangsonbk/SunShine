...
public class TestDb extends AndroidTestCase {
    ...
    public void testInsertReadDb() {
        ...
        /*String[] columns = {
                ...
                LocationEntry.COLUMN_LATITIDE,
                LocationEntry.COLUMN_LOGITUDE
        };*/

        // A cursor is your primary interface to the query results.
        Cursor cursor = db.query(
                LocationEntry.TABLE_NAME,  // Table to Query
                null, //all column instead of coloumns
        ...
        if (cursor.moveToFirst()) {
            ...
            int latIndex = cursor.getColumnIndex((LocationEntry.COLUMN_LATITIDE));
            double latitude = cursor.getDouble(latIndex);

            int longIndex = cursor.getColumnIndex((LocationEntry.COLUMN_LOGITUDE));
    ...
    static ContentValues createNorthPoleLocationValues() {
        ...
        testValues.put(LocationEntry.COLUMN_LATITIDE, 64.7488);
        testValues.put(LocationEntry.COLUMN_LOGITUDE, -147.353);
